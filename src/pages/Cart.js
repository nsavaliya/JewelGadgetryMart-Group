            ...
            <div className="row d-flex justify-content-center my-4">
              <div className="col-md-8">
                <div className="card mb-4" >
                  <div className="card-header py-3" style={{ backgroundColor: '#0E1C4E', color: '#ffff' }}>
              ...
              <div className="col-md-4">
                <div className="card mb-4">
                  ...
                  <div className="card-body">
                    ...
                    <Link
                      to="/checkout"
                      className="btn btn-dark btn-lg btn-block"  style={{ backgroundColor: '#0E1C4E', color: '#ffff' }}
                    >
                      Go to checkout
                    </Link>
                  </div>
  ...
  return (
    <>
      ...
      <div className="container my-3 py-3">
        <h1 className="text-center">Cart Management</h1>
        <hr />
